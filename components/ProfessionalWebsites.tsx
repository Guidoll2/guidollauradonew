...
export default function ProfessionalWebsites() {
  ...
  const handleAddToCart = () => {
    addItem({
      id: 'professional-web',
      name: t.professionalWebTitle,
      price: t.professionalWebPrice,
      priceNumber: 500,
      quantity: 1,
      source: 'professional'
    });
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-gray-50 via-white to-gray-100 relative overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-20 right-10 w-72 h-72 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-float-smooth"></div>
      <div className="absolute -bottom-8 left-20 w-72 h-72 bg-purple-200 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-float-smooth" style={{ animationDelay: '2s' }}></div>

      <div className="max-w-4xl mx-auto px-6 relative z-10">
        {/* Header */}
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-4">
            {t.professionalWebTitle}
          </h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
            {t.professionalWebDescription}
          </p>
        </div>

        {/* Main Card with Glass Effect Images */}
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl border-2 border-blue-400 shadow-2xl p-8 md:p-12 animate-slide-in-scale hover:animate-glow-pulse transition-all duration-300 hover:border-blue-500">
          
          {/* Single Image with Navigation */}
          <div className="relative group rounded-2xl overflow-hidden h-80 mb-12">
            {/* Badge */}
            <div className="absolute top-4 left-4 z-20 border-2 border-blue-400 px-4 py-2 rounded-lg bg-white/95 text-black font-semibold text-sm">
              {t.completedProjects}
            </div>
            ...
            <Image
              ...
              alt={`Professional Website Example ${currentImageIndex + 1}`}
              fill
            ...
            <div className="absolute inset-0 z-15 bg-black/40 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-end justify-center pb-6">
              <a 
                ...
                className="bg-white/95 text-blue-600 font-semibold px-6 py-3 rounded-lg hover:bg-white transition-all duration-300 text-center"
              >
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  t.videoRendering,
                  t.advancedFeatures,
                  t.professionalDesign,
                  t.contentManagement,
                  t.analyticsIntegration,
                  t.seoOptimization
                ].map((feature, idx) => (
                  <li key={idx} className="flex items-center gap-3 text-gray-700 hover:text-blue-600 transition-colors duration-300">
            ...
            <div className="flex flex-col items-center justify-center space-y-6">
              <div className="text-center">
                ...
                <p className="text-6xl font-bold text-blue-600 mb-2">500€</p>
        ...
        <div className="mt-16 text-center animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          ...
          <button 
            ...
            className="text-blue-600 font-semibold hover:text-blue-700 transition-colors duration-300 inline-flex items-center gap-2"
          >
            {t.moreServices}
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
