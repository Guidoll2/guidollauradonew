...
<h3 className="flex text-3xl text-center text-gray-200 p-2 md:text-4xl">Contact me:</h3>
        ...
        <img src="calendario.png" alt="calendarico" className="w-8"></img>
        ...
        <img src="gmaili.png" alt="mailico" className="w-8"></img>
        ...
        <img src="phonei.png" alt="phoneico" className="w-8"></img>
        ...
        <img src="igblack.png" alt="instagramico" className="w-8"></img>
