...
export default function Home() {
   return (
     ...
     <Image src="/Full-no-bg.png" alt="empleargpicture" width={1000} height={1000} className="w-1/4" />
    
    <div className="flex flex-col items-center">
     
     <p className="text-3xl text-white ">Sitio en construcción, seguinos en Instagram!</p>
