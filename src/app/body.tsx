                ...
                <div id="containeroptions" className="flex grid grid-cols-1 md:grid md:grid-cols-3 md:p-0  bg-gradient-to-tr from-gray-500 to-gray-600">
                    ...
                    <div className="relative group p-10 order-3" id="containerwebpremium">
                        ...
                        <ul className="flex grid grid-cols-1 p-10 rounded-[5px] z-0 list-disc bg-gradient-to-tl from-blue-600 via-sky-600 to-blue-300">
                            ...
                            <a href="premium"> <button className="absolute bottom-4 left-1/2 transform -translate-x-1/2 text-xl bg-gray-200 px-4 py-2 rounded-full text-black z-10 border-[1px] border-gray-400 md:text-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300"><span className="text-gray-700">More details</span></button></a>
                        </ul>
                    </div>
                </div>
